...
public class MainNetMinerTest {
    ...
    public void submitBitcoinBlockProofOfWorkNotGoodEnough() {
        ...
        MinerServer minerServer = new MinerServerImpl(config, ethereumImpl, this.blockchain, null, this.blockchain.getTransactionPool(), blockchain.getRepository(), ConfigUtils.getDefaultMiningConfig(), unclesValidationRule, world.getBlockProcessor(), DIFFICULTY_CALCULATOR,
    ...
    public void submitBitcoinBlockInvalidBlockDoesntEliminateCache() {
        ...
        MinerServer minerServer = new MinerServerImpl(config, ethereumImpl, this.blockchain, null,
                null, this.blockchain.getTransactionPool(), blockchain.getRepository(),
