...
public class Web3ImplSnapshotTest {
    ...
    static MinerServer getMinerServerForTest(World world, SimpleEthereum ethereum) {
        ...
        return new MinerServerImpl(config, ethereum, world.getBlockChain(), world.getBlockChain().getBlockStore(), null,
                world.getBlockChain().getTransactionPool(), world.getBlockChain().getRepository(), ConfigUtils.getDefaultMiningConfig(), rule, world.getBlockProcessor(), new DifficultyCalculator(config), new GasLimitCalculator(config),
